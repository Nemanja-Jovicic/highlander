  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        <!-- deo za admina -->
        <li class="nav-item">
          <a class="nav-link active" href="admin.php?page=pocetna">Pocetna</a>
        </li>
        <li class="nav-item"><a href="admin.php?page=kategorije" class="nav-link">Kategorije</a></li>
        <li class="nav-item"><a href="admin.php?page=ture" class="nav-link">Ture</a></li>
