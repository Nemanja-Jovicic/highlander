...
<main class="container">
    ...
    <div class="row mt-2">
                    ...
                    <tbody id="dates">
                        <?php foreach ($dates as $index =>  $date): ?>
                            <tr id="date_<?= $index ?> ?>">
                                ...
                                <td><?= date('d/m/Y H:i:s', strtotime($date->start_date)) ?></td>
                                ...
                                <td><button class="btn btn-sm btn-success btn-edit btn-edit-tour"
                                        type="buton" data-id="<?= $date->id ?>" data-index="<?= $index ?>">Izmeni</button></td>
                                <td>
                                    <button class="btn btn-sm btn-danger btn-delete btn-delete-tour" type="button" data-id="<?= $date->id ?>"
        ...
        <div class="col-lg-4 mt-4 mt-lg-0">
            ...
            <input type="hidden" name="tour_date_index" id="tour_date_index">
            <input type="hidden" name="tour_date_id" id="tour_date_id">
            <div class="mb-2">
