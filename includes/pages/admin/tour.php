                    ...
                    <tbody id="tour">
                        <?php foreach ($tours as $index => $tour): ?>
                            <tr id='tour_<?= $tour->id ?>'>
                                ...
                                <td><a href="admin.php?page=galerija&id=<?= $id ?> ?>" class="btn btn-sm btn-primary">Dodaj</a></td>
                                ...
                                <td>
                                    <button type="button" class="btn  btn-sm btn-danger btn-delete btn-delete-tour"><?= $tour->is_deleted === 0 ? "Izbrisi" : "Aktiviraj" ?></button>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
