<div class="container">
    <div class="row mt-5">
        <div class="col-10 col-md-6 col-lg-4 mx-auto">
            ...
            <h1 class="fs-5 text-center">Registracija</h1>
            <form action="#" method="post">
                ...
                <div class="d-grid mb-3">
                    <button class="btn btn-sm btn-primary" id="btnRegister" type="button">Registruj se</button>
                </div>
                <div class="d-flex justify-content-center gap-2">
                    <span>Vec imate nalog?</span>
                    <a href="index.php?page=login">Prijavi se </a>
                </div>
            </form>
        </div>
    </div>
